...
func TestTftpFiles(t *testing.T) {
	...
	_, hh := ServeTftp(":3235235", fs.TftpResponder(), logger, backend.NewPublishers())
	if hh != nil {
	...
	_, hh = ServeTftp("1.1.1.1:11112", fs.TftpResponder(), logger, backend.NewPublishers())
	if hh != nil {
	...
	srv, hh := ServeTftp("127.0.0.1:11112", fs.TftpResponder(), logger, backend.NewPublishers())
	if hh != nil {
