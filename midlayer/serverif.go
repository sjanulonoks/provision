...
type serveIfConn struct {
	handlers map[int]dhcp.Handler
	conn     *ipv4.PacketConn
	cm       *ipv4.ControlMessage
}

func (s *serveIfConn) ReadFrom(b []byte) (n int, addr net.Addr, handler dhcp.Handler, err error) {
...
func ServeIf(conn net.PacketConn, handlers map[int]dhcp.Handler) error {
