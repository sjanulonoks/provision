...
func TestStaticFiles(t *testing.T) {
	...
	svr, hh := ServeStatic(":3235235", backend.NewFS(".", logger), logger, backend.NewPublishers())
	if hh != nil {
	...
	svr, hh = ServeStatic(":32134", backend.NewFS(".", logger), logger, backend.NewPublishers())
	if hh != nil {
